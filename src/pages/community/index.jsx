...
const ABVCAPLogo = ({ height = 36 }) => (
  <img src="/assets/images.jpg" alt="ABVCAP" height={height} style={{ objectFit: "contain" }} />
);
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            {[
              ...
              "Focused on Investment Team professionals",
            ].map((item) => (
      ...
      <section style={{ padding: "6rem 2.5rem", background: "#fff", borderTop: "1px solid #efefea" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            {[
              { label: "FM/Derraik", node: <img src="/assets/FM_Derraik (1).png" alt="FM/Derraik" height={108} style={{ objectFit: "contain" }} /> },
