...
const SPEAKERS = [
  ...
  { name: "Shu Nyatta", role: "Managing Partner", fund: "Bicycle Capital", quarter: "Q4 · 2025", img: "/assets/02_shu_nyatta.jpg" },
      ...
      <section style={{ padding: "5rem 2.5rem", background: "#f0f0eb" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            {["Works full time at a VC or CVC firm", "Analyst, Associate, or Principal — 3 to 10 years in the ecosystem", "Focused on Investment Team professionals"].map((item) => (
      ...
      <section style={{ padding: "6rem 2.5rem", background: "#fff", borderTop: "1px solid #efefea" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "1px", background: "#efefea", border: "1px solid #efefea", borderRadius: 4, overflow: "hidden", marginBottom: "3rem" }}>
            {[
              { label: "FM/Derraik", node: <img src="/assets/FM_Derraik (1).png" alt="FM/Derraik" height={108} style={{ objectFit: "contain", maxWidth: 220 }} /> },
              { label: "ABVCAP", node: <img src="/assets/images.jpg" alt="ABVCAP" height={72} style={{ objectFit: "contain", maxWidth: 220 }} /> },
              { label: "AWS", node: <AWSLogo height={42} /> },
